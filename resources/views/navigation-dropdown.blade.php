            ...
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                     <img src="../mesoft-logo.png" style="max-width:35px;">
                 </a>
             </div>
        ...
        <div class="hidden sm:flex sm:items-center sm:ml-6">
            <x-jet-dropdown align="right" width="48">
                ...
                <x-slot name="content">
                    ...
                    <x-jet-dropdown-link href="{{ route('recommend') }}">
                        {{ __('Polecaj aplikację') }}
                    </x-jet-dropdown-link>

                    <x-jet-dropdown-link href="{{ route('communicator') }}" :active="request()->routeIs('communicator')">
                        {{ __('Komunikator') }}
