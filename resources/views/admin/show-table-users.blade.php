  ...
  <table class="table table-hover mt-4">
    ...
    <tbody>
      ...
      <tr>
        ...
        @endforeach
        <td>
          <button type="button" class="btn btn-outline-success btn-sm" wire:click="$emit('action', {{ $item['id'] }})">
            <span class="d-inline">Akcje</span>
          </button>
        </td>
      </tr>
      @endforeach
      @else
      <tr><td colspan="{{ count($headers) }}"><h2>Brak kont o podanych parametrach.</h2></td></tr>
      @endif
